...
<link href="<?php echo Yii::$app->request->baseUrl.'/'.'company/css/styles.css' ?>" rel="stylesheet">
<link href="<?php echo Yii::$app->request->baseUrl.'/'.'company/css/animation.css'?>" rel="stylesheet">
<!-- 返回顶部调用 begin -->
<link href="<?php echo Yii::$app->request->baseUrl.'/'.'company/css/lrtk.css'?>" rel="stylesheet" />
<script type="text/javascript" src="<?php echo Yii::$app->request->baseUrl.'/'.'company/js/jquery.js'?>"></script>
<script type="text/javascript" src="<?php echo Yii::$app->request->baseUrl.'/'.'company/js/js.js'?>"></script>
<!-- 返回顶部调用 end-->
<!--[if lt IE 9]>
...
<header>
  <nav id="nav">
   ...
   <ul><li><a href="?r=total/nums">网站统计</a></li></ul>
...
<div id="mainbody">
  <div class="info">
    <figure> <img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/art.jpg'?>"  alt="Panama Hat">
  ...
  <div class="blogs">
    <ul class="bloglist">
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/s1.jpg'?>"></a>
      ...
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/s2.jpg'?>"></a>
      ...
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/s3.jpg'?>"></a>
      ...
      <li>
        <div class="arrow_box">
          ...
          <h2 class="title"><a href="/" target="_blank">谁更心软，谁就先长大</a></h2>
          <ul class="textinfo">
            <a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/s4.jpg'?>"></a>
            <p> 男人都是孩子，需要用一生时间来长大。女人都想当孩子，却最擅长的角色是妈妈。恋爱一开始，是两个孩子之间的游戏，到后来，成了大人和孩子之间的游戏。恋爱这回事，总要有一个人先长大，对另一半多些包容和宠溺。而通常来看：谁更心软，谁就先长大...</p>
          </ul>
          <ul class="details">
            <li class="likes"><a href="#">102</a></li>
      ...
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/s5.jpg'?>"></a>
    ...
    <aside>
      ...
      <div class="toppic">
        <h2>图文并茂</h2>
        <ul>
          <li><a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/k01.jpg'?>">腐女不可怕，就怕腐女会画画！
            <p>伤不起</p>
            </a></li>
          <li><a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/k02.jpg'?>">问前任，你还爱我吗？无限戳中泪点~
            <p>感兴趣</p>
            </a></li>
          <li><a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/k03.jpg'?>">世上所谓幸福，就是一个笨蛋遇到一个傻瓜。
            <p>喜欢</p>
            </a></li>
        </ul>
      </div>
...
<footer>
  <div class="footer-mid">
    ...
    <div class="visitors">
      <h2>最新评论</h2>
      <dl>
        <dt><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/s8.jpg'?>">
        <dt>
        <dd>DanceSmile
          <time>49分钟前</time>
        </dd>
      ...
      <dl>
        <dt><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/s7.jpg'?>">
        <dt>
        <dd>yisa
          <time>2小时前</time>
        </dd>
      ...
      <dl>
        <dt><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/s6.jpg'?>">
        <dt>
        <dd>小林博客
          <time>8月7日</time>
        </dd>
    ...
    <section class="flickr">
      <h2>摄影作品</h2>
      <ul>
        <li><a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/01.jpg'?>"></a></li>
        <li><a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/02.jpg'?>"></a></li>
        <li><a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/03.jpg'?>"></a></li>
        <li><a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/04.jpg'?>"></a></li>
        <li><a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/05.jpg'?>"></a></li>
        <li><a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/06.jpg'?>"></a></li>
        <li><a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/07.jpg'?>"></a></li>
        <li><a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/08.jpg'?>"></a></li>
        <li><a href="/"><img src="<?php echo Yii::$app->request->baseUrl.'/'.'company/images/09.jpg'?>"></a></li>
      </ul>
    </section>
  </div>
